...
```
Python (Advanced)  •  R (Intermediate)
```

### Machine Learning & Deep Learning
- **Frameworks:** PyTorch, TensorFlow
- **Computer Vision:** U-Net, CNN, Image Segmentation, Object Detection
- **Time Series:** ARIMA, LSTM, Prophet, Statistical Forecasting
- **NLP:** Text Classification, Regression on Text Data
- **Model Development:** Training, Fine-tuning, Deployment

### Data Science & Tools
- **Data Processing:** Pandas, NumPy, Data Wrangling
- **Visualization:** Matplotlib, Seaborn, Plotly
- **Other Tools:** Git, Jupyter, Web Scraping, SQL
...
**Technologies:** PyTorch, CNN, Image Processing, Transfer Learning
...
**Technologies:** Python, NLP, Text Analysis, Regression Models
